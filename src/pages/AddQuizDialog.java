...
public class AddQuizDialog extends JDialog {
    ...
    public AddQuizDialog(Frame parent, Lesson lesson, Course course, int instructorId) {
        super(parent, "Add Quiz to Lesson", true);
        this.lesson = lesson;
        this.course = course;
    ...
    private void initComponents() {
        ...
        JLabel headerLabel = new JLabel("Create Quiz for: " + lesson.getTitle());
        ...
        JButton saveButton = new JButton("Create Quiz");
    ...
    private void saveQuiz() {
        ...
        try {
            ...
            courseDb.addQuiz(lesson.getId(), retries, passingScore, questions);
            ...
            Course updatedCourse = courseDb.getCourseById(course.getId());
            ManageCourseFrame.start(updatedCourse, instructorId);

        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this,
                    "Error creating quiz: " + ex.getMessage(),
                    "Error",
                    JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    ...
    // Inner class for Question Panel
    private class QuestionPanel extends JPanel {
        ...
        public QuestionPanel(int number) {
            ...
            numberLabel.setForeground(new Color(0, 102, 204));
        ...
        private void addChoice() {
            ChoicePanel choicePanel = new ChoicePanel((char)('A' + choicePanels.size()));
    ...
    public static void showDialog(Lesson lesson, Course course, int instructorId, Frame parent) {
        AddQuizDialog dialog = new AddQuizDialog(parent, lesson, course, instructorId);
