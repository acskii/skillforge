...
public class EditLessonDialog extends JDialog {
    ...
    public EditLessonDialog(Frame parent, Course course, Lesson lesson) {
        super(parent, "Edit Lesson", true);
        this.course = course;
        this.lesson = lesson;
        initComponents();
        loadLessonData();
    ...
    private void initComponents() {
        ...
        JLabel headerLabel = new JLabel("Edit Lesson");
    ...
    private void saveLesson() {
        ...
        try {
            ...
            CourseDatabase.getInstance().updateLesson(lesson);
    ...
    public static void showDialog(Course course, Lesson lesson, Frame parent) {
        EditLessonDialog dialog = new EditLessonDialog(parent, course, lesson);
